package com.example.teacher_module.ui.mainActivity
...
import com.example.teacher_module.ui.navigation.NavGraphTeacher
            ...
            AppTheme {
                Surface(color = MaterialTheme.colors.background) {
                    ...
                    viewModel = daggerViewModel {
                        (application as TeacherApplication).teacherComponent.getMainActivityViewModel()
                    }
    ...
    private fun getClient(): GoogleSignInClient {
        val gso =
            GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("298185404963-vbm5no47f7klvc46c99s7ao84f3m25um.apps.googleusercontent.com")
                .requestEmail()
                .build()
